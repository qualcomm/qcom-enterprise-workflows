# Contributing to qcom-enterprise-workflows
...
1. [Fork](https://github.com/qualcomm/qcom-enterprise-workflows/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/qcom-enterprise-workflows.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/qcom-enterprise-workflows.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/qcom-enterprise-workflows/pulls) from your branch to `main`.
